                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="sem1[]" value="@if(!empty($data->sem1)) {{$data->sem1}} @endif">
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="sem2[]" value="@if(!empty($data->sem2)) {{$data->sem2}} @endif">
                                        </div>
                                    </td>
                                </tr>
                                @elseif($data->no > 1)
