...
<div class="content" id="printChart" style=" margin-bottom: 5%">
  <figure class="org-chart cf">
      ...
      <li>                  
        <ul class="director">
          <li>
            ...
            <a href="#"><span>GENERAL MANAGER</span>
             
              <table class="table table-bordered" style="margin-top: 5px;">
                <tr>
                  <th class="tg-031e">PCR</th>
                  
                  <th class="tg-yw4l">@if(count($gen_manager) > 0){{$gen_manager->pcr.'%'}} @else 0% @endif</th>
            ...
            <ul class="departments cf">                             
              ...
              <li class="department dep-a">
               ...
               <a href="#"><span>MANAJER ENJINIRING & QUALITY ASSURANCE</span>
                 <table class="table table-bordered" style="margin-top: 5px;">
                  <tr>
                    <th class="tg-031e">PCR</th>
                    <th class="tg-yw4l">{{$man_enjiniring->pcr.'%'}}</th>
                  </tr>
                  <tr>
                    <td class="tg-yw4l">Dept.Read</td>
              ...
              <ul class="sections">
                <li class="section"><a href="#"><span>SPV Senior System Owner PLTGU</span>
                 ...
                 <table class="table table-bordered" style="margin-top: 5px;">
                  <tr>
                    <th class="tg-031e">PCR</th>
                    <th class="tg-yw4l">{{$spv_ownerpltgu->pcr.'%'}}</th>
                  </tr>
                  <tr>
              ...
              <li class="section"><a href="#"><span>SPV Senior System Owner Common CNG</span>
                ...
                <table class="table table-bordered" style="margin-top: 5px;">
                  <tr>
                    <th class="tg-031e">PCR</th>
                    <th class="tg-yw4l">{{$spv_ownercng->pcr.'%'}}</th>
                  </tr>
                  <tr>
                    <td class="tg-yw4l">JCR.Staff</td>
                    <td class="tg-yw4l"></td>
              ...
              <li class="section"><a href="#"><span>SPV Senior Technology Owner</span>
                ...
                <table class="table table-bordered" style="margin-top: 5px;">
                  <tr>
                    <th class="tg-031e">PCR</th>
                    <th class="tg-yw4l">{{$spv_technoowner->pcr.'%'}}</th>
                  </tr>
                  <tr>
                    <td class="tg-yw4l">JCR.Staff</td>
                    <td class="tg-yw4l"></td>
              ...
              <li class="section ends"><a href="#"><span>SPV Senior Manajemen Mutu, Risiko & Kepatuhan</span>
                ...
                <table class="table table-bordered" style="margin-top: 5px;">
                  <tr>
                    <th class="tg-031e">PCR</th>
                    <th class="tg-yw4l">{{$spv_muturisiko->pcr.'%'}}</th>
                  </tr>
                  <tr>
                    <td class="tg-yw4l">JCR.Staff</td>
                    <td class="tg-yw4l"></td>
          ...
          <li class="department dep-b">
            ...
            <a href="#"><span>MANAGER OPERASI</span>
             <table class="table table-bordered" style="margin-top: 5px;">
              <tr>
                <th class="tg-031e">PCR</th>
                <th class="tg-yw4l">{{$man_operasi->pcr.'%'}}</th>
              </tr>
              <tr>
                <td class="tg-yw4l">Dept.Read</td>
          ...
          <ul class="sections">
            <li class="section"><a href="#"><span>SPV Senior Rendal Operasi Blok 1-2 & Niaga</span>
              ...
              <table class="table table-bordered" style="margin-top: 5px;">
                <tr>
                  <th class="tg-031e">PCR</th>
                  <th class="tg-yw4l">{{$spv_rendal12->pcr.'%'}}</th>
                </tr>
                <tr>
                  <td class="tg-yw4l">JCR.Staff</td>
                  <td class="tg-yw4l"></td>
            ...
            <li class="section"><a href="#"><span>SPV Senior Rendal Operasi Blok 3-4, 5</span>
              ...
              <table class="table table-bordered" style="margin-top: 5px;">
                <tr>
                  <th class="tg-031e">PCR</th>
                  <th class="tg-yw4l">{{$spv_rendal345->pcr.'%'}}</th>
                </tr>
                <tr>
                  <td class="tg-yw4l">JCR.Staff</td>
                  <td class="tg-yw4l"></td>
            ...
            <li class="section ends"><a href="#"><span>SPV Senior Produksi (A,B,C,D,E)</span>     
             <table class="table table-bordered" style="margin-top: 5px;">
              <tr>
                <th class="tg-031e">PCR</th>
                <th class="tg-yw4l">@if(count($spv_produksiabcde) > 0){{$spv_produksiabcde->pcr.'%'}} @else 0% @endif</th>
              </tr>
              <tr>
                <td class="tg-yw4l">JCR.Staff</td>
                <td class="tg-yw4l"></td>
      ...
      <li class="department dep-c">
        <a href="#"><span>MANAGER PEMELIHARAAN</span>
         <table class="table table-bordered" style="margin-top: 5px;">
          <tr>
            <th class="tg-031e">PCR</th>
            <th class="tg-yw4l">{{$man_pemeliharaan->pcr.'%'}}</th>
          </tr>
          <tr>
            <td class="tg-yw4l">Dept.Read</td>
      ...
      <ul class="sections">
        <li class="section"><a href="#"><span>SPV Senior Rendal Pemeliharaan</span>
          ...
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">{{$spv_rendalpemeliharaan->pcr.'%'}}</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
        ...
        <li class="section"><a href="#"><span>SPV Senior Pemeliharaan Mesin</span>
          ...
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">{{$spv_mesin12->pcr.'%'}}</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
        ...
        <li class="section"><a href="#"><span>SPV Senior Pemeliharaan Listrik</span>
          ...
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">{{$spv_listrik12->pcr.'%'}}</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
        ...
        <li class="section"><a href="#"><span>SPV Senior Pemeliharaan Kontrol & Inst.</span>
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">{{$spv_kontrol12->pcr.'%'}}</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
        ...
        <li class="section"><a href="#"><span>SPV Senior Outage Management</span>
          ...
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">@if(count($spv_outage) > 0){{$spv_outage->pcr.'%'}} @else 0% @endif</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
        ...
        <li class="section"><a href="#"><span>SPV Senior K3</span>
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">@if(count($spv_k3) > 0){{$spv_k3->pcr.'%'}} @else 0% @endif</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
        ...
        <li class="section"><a href="#"><span>SPV Senior Lingkungan</span>
          ...
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">{{$spv_lingkungan->pcr.'%'}}</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
        ...
        <li class="section ends"><a href="#"><span>SPV Senior Sarana</span>
          ...
          <table class="table table-bordered" style="margin-top: 5px;">
            <tr>
              <th class="tg-031e">PCR</th>
              <th class="tg-yw4l">{{$spv_sarana->pcr.'%'}}</th>
            </tr>
            <tr>
              <td class="tg-yw4l">JCR.Staff</td>
              <td class="tg-yw4l"></td>
    ...
    <li class="department dep-d">
     <a href="#"><span>MANAGER KUANGAN & ADMINISTRASI</span>
       <table class="table table-bordered" style="margin-top: 5px;">
        <tr>
          <th class="tg-031e">PCR</th>
          <th class="tg-yw4l">{{$man_keuangan->pcr.'%'}}</th>
        </tr>
        <tr>
          <td class="tg-yw4l">Dept.Read</td>
    ...
    <ul class="sections">
      <li class="section"><a href="#"><span>SPV Senior SDM</span>
        <table class="table table-bordered" style="margin-top: 5px;">
          <tr>
            <th class="tg-031e">PCR</th>
            <th class="tg-yw4l">{{$spv_sdm->pcr.'%'}}</th>
          </tr>
          <tr>
            <td class="tg-yw4l">JCR.Staff</td>
            <td class="tg-yw4l"></td>
      ...
      <li class="section"><a href="#"><span>SPV Senior Umum & CSR</span>
        ...
        <table class="table table-bordered" style="margin-top: 5px;">
          <tr>
            <th class="tg-031e">PCR</th>
            <th class="tg-yw4l">{{$spv_umum->pcr.'%'}}</th>
          </tr>
          <tr>
            <td class="tg-yw4l">JCR.Staff</td>
            <td class="tg-yw4l"></td>
      ...
      <li class="section ends"><a href="#"><span>SPV Senior Keuangan</span>
        ...
        <table class="table table-bordered" style="margin-top: 5px;">
          <tr>
            <th class="tg-031e">PCR</th>
            <th class="tg-yw4l">{{$spv_keuangan->pcr.'%'}}</th>
          </tr>
          <tr>
            <td class="tg-yw4l">JCR.Staff</td>
            <td class="tg-yw4l"></td>
  ...
  <li class="department dep-e">
    <a href="#"><span>MANAJER LOGISTIK</span>
     <table class="table table-bordered" style="margin-top: 5px;">
      <tr>
        <th class="tg-031e">PCR</th>
        <th class="tg-yw4l">{{$man_logistik->pcr.'%'}}</th>
      </tr>
      <tr>
        <td class="tg-yw4l">Dept.Read</td>
  ...
  <ul class="sections">
    <li class="section"><a href="#"><span>SPV Senior Pengadaan</span>
      ...
      <table class="table table-bordered" style="margin-top: 5px;">
        <tr>
          <th class="tg-031e">PCR</th>
          <th class="tg-yw4l">{{$spv_pengadaan->pcr.'%'}}</th>
        </tr>
        <tr>
          <td class="tg-yw4l">JCR.Staff</td>
          <td class="tg-yw4l"></td>
    ...
    <li class="section"><a href="#"><span>SPV Senior Administrasi  Gudang</span>
      <table class="table table-bordered" style="margin-top: 5px;">
        <tr>
          <th class="tg-031e">PCR</th>
          <th class="tg-yw4l">{{$spv_gudang->pcr.'%'}}</th>
        </tr>
        <tr>
          <td class="tg-yw4l">JCR.Staff</td>
          <td class="tg-yw4l"></td>
    ...
    <li class="section ends"><a href="#"><span>SPV Senior Inventori Kontrol & Kataloger</span>
      <table class="table table-bordered" style="margin-top: 5px;">
        <tr>
          <th class="tg-031e">PCR</th>
          <th class="tg-yw4l">{{$spv_inventori->pcr.'%'}}</th>
        </tr>
        <tr>
          <td class="tg-yw4l">JCR.Staff</td>
          <td class="tg-yw4l"></td>
...
<li class="department dep-f">
  <a href="#"><span>MANAGER CNG & BAHAN BAKAR</span>
   <table class="table table-bordered" style="margin-top: 5px;">
    <tr>
      <th class="tg-031e">PCR</th>
      <th class="tg-yw4l">{{$man_cng->pcr.'%'}}</th>
    </tr>
    <tr>
      <td class="tg-yw4l">Dept.Read</td>
...
<ul class="sections">
  <li class="section"><a href="#"><span>SPV Senior Rendal CNG & Bahan Bakar</span>
    ...
    <table class="table table-bordered" style="margin-top: 5px;">
      <tr>
        <th class="tg-031e">PCR</th>
        <th class="tg-yw4l">{{$spv_cng->pcr.'%'}}</th>
      </tr>
      <tr>
        <td class="tg-yw4l">JCR.Staff</td>
        <td class="tg-yw4l"></td>
  ...
  <li class="section ends"><a href="#"><span>SPV Senior Operasi & Pemeliharaan CNG</span>
    <table class="table table-bordered" style="margin-top: 5px;">
      <tr>
        <th class="tg-031e">PCR</th>
        <th class="tg-yw4l">{{$spv_cngplant->pcr.'%'}}</th>
      </tr>
      <tr>
        <td class="tg-yw4l">JCR.Staff</td>
        <td class="tg-yw4l"></td>
