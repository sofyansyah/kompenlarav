...
<script type="text/javascript">
    ...
    var orgChart = new getOrgChart(document.getElementById("people"), {
        ...
        dataSource: [
        { id: 1, parentId: null, name: "GENERAL MANAGER UNIT PEMBANGKITAN MUARA TAWAR", pcr: "99%", dept_read: "98%"},
        ...
        { id: 21, parentId: 4, name: "SPV Senior Lingkungan", pcr: "99%", jcr_staff: "98%" },
